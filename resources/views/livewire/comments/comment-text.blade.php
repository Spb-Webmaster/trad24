<div class="livewire_component__comment_text web_comments_wrap">
    {{-- In work, do what you enjoy. --}}
    @forelse($comments as $comment)
        <div class="web_comment_wrap">
                ...
                <div class="web_comment__flex">
                    ...
                    <div class="web_comment__text_wrap">
                        ...
                        <div class="web_comment_date__flex">
                            ...
                            @if($comment->to_answer)
                                <div class="web_comment__answer"><span class="to_answer" wire:click="showAnswerForm({{$comment->id}})">Ответить</span></div>
                            @endif
                        ...
                        <div class="show_answer_form">
                                @livewire('comments.comment-answer', ['comment_id' => $comment->id, 'article_id' => $article_id])
                        </div>
                        @endif
