...
/**
 * @extends ModelResource<FamilyGallery>
 */
class FamilyGalleryResource extends ModelResource
{
    protected string $model = FamilyGallery::class;

    protected string $title = 'Фотогалерея';
