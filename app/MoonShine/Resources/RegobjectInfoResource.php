...
/**
 * @extends ModelResource<RegobjectInfo>
 */
class RegobjectInfoResource extends ModelResource
{
    protected string $model = RegobjectInfo::class;

    protected string $title = 'Полезная инфориация об объекте';
